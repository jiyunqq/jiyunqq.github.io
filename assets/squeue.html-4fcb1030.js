...
</code></pre></div><p>随后执行 <code>source ~./bashrc</code> 或者重新登录, 然后执行 <code>sq</code> 就可以安装指定格式显示自己的作业信息</p><ul><li><strong>常用参数</strong></li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token parameter variable">--help</span>    <span class="token comment"># 显示squeue命令的使用帮助信息；</span>
