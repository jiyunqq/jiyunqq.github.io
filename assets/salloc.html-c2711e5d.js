...
</code></pre></div><p>当运行调试完程序后切记使用scancel释放资源，并执行squeue -j xxx可查看作业是否还在运行，避免占用资源却未运行作业造成意料之外的收费。</p><ul><li><strong>常用参数</strong></li></ul><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token parameter variable">--help</span>                <span class="token comment"># 显示帮助信息；</span>
...
</code></pre></div>`,11),m={href:"https://slurm.schedmd.com/salloc.html",target:"_blank",rel:"noopener noreferrer"};function i(u,b){const s=r("ExternalLinkIcon");return e(),p("div",null,[k,a("p",null,[a("a",m,[t("更多使用详情"),o(s)])])])}const d=n(c,[["render",i],["__file","salloc.html.vue"]]);export{d as default};
